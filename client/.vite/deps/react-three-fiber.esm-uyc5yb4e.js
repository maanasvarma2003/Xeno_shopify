...
import { t as require_react } from "./react-CRAmqRMp.js";
import { $a as Raycaster, Ds as Vector3, Es as Vector2, Fr as LinearSRGBColorSpace, Gi as PCFSoftShadowMap, L as BasicShadowMap, Ti as NoToneMapping, Ts as VSMShadowMap, Ui as OrthographicCamera, Wi as PCFShadowMap, _s as UnsignedByteType, a as WebGLRenderer, at as Clock, c as ACESFilmicToneMapping, ct as ColorManagement, fo as SRGBColorSpace, fr as Layers, ha as RGBAFormat, mo as Scene, ot as Color, qi as PerspectiveCamera, s as three_module_exports } from "./three.module-t3zK-xvB.js";
import { t as require_with_selector } from "./with-selector-CvFKqWDT.js";
import { t as require_jsx_runtime } from "./jsx-runtime-BYDbIXb7.js";
...
function useBridge() {
	...
	return import_react.useMemo(() => ({ children }) => {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(!!i(fiber, true, (node) => node.type === import_react.StrictMode) ? import_react.StrictMode : import_react.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContextBridge, { children }) });
	}, [fiber, ContextBridge]);
}
function Block({ set }) {
					...
					let raycastEvent = {
						...
						stopPropagation() {
							...
							if (!capturesForPointer || capturesForPointer.has(hit.eventObject)) {
								...
								if (internal.hovered.size && Array.from(internal.hovered.values()).find((i$2) => i$2.eventObject === hit.eventObject)) cancelPointer([...intersections.slice(0, intersections.indexOf(hit)), hit]);
							}
						},
						target: {
							hasPointerCapture,
...
var import_react_reconciler = require_react_reconciler();
...
//# sourceMappingURL=react-three-fiber.esm-uyc5yb4e.js.map